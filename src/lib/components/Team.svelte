			...
			>
				...
				<div class="p-5">
					...
					<ul class="flex space-x-4 sm:mt-0">
						<li>
							<a href="https://" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
